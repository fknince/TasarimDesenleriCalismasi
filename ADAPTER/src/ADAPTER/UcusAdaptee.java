...
public class UcusAdaptee {
     ...
     public ObservableList<Ucus> ucusAra(Ucus arama_kriterleri)
     {
        
         aranan_ucus_listesi.clear();
         int fiyat_kistasi=arama_kriterleri.getFiyatKistasi();
     ...
     public boolean ucus_guncelle(Ucus ucus)
     {
